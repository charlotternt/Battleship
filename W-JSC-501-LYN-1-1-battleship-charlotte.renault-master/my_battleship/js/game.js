...
(function (global) {
    "use strict";
    var audioTouche = new Audio("/touche.mp3");
    var audioMiss = new Audio("/eau.mp3");
    var audioTir = new Audio("/tir.mp3");
    ...
    var game = {
        ...
        handleMouseMove: function (e) {
            ...
            if (this.getPhase() === this.PHASE_INIT_PLAYER && e.target.classList.contains("cell")) {
                ...
                if(((ship.life)%2) === 0 && ship.pos === "vertical") {
        ...
        handleRightClick: function(ev){
            ...
            var ship = this.players[0].fleet[this.players[0].activeShip];
                ...
                if(ship.getLife()%2 === 0) {
                    ship.dom.style.top = "" + (utils.eq(ev.target.parentNode)) * utils.CELL_SIZE - (600 + (this.players[0].activeShip) * 60 - 30) + "px";
                    ship.dom.style.left = "" + utils.eq(ev.target) * utils.CELL_SIZE - Math.floor(ship.getLife() / 2) * utils.CELL_SIZE + 30 + "px";
                 }
